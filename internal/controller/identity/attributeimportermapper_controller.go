...
// +kubebuilder:rbac:groups=identity.keycloak-operator.webhippie.de,resources=attributeimportermappers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=identity.keycloak-operator.webhippie.de,resources=attributeimportermappers/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=identity.keycloak-operator.webhippie.de,resources=attributeimportermappers/finalizers,verbs=update
