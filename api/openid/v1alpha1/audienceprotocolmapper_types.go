...
type AudienceProtocolMapper struct {
	...
	// spec defines the desired state of AudienceProtocolMapper
	// +required
	Spec AudienceProtocolMapperSpec `json:"spec"`

	// status defines the observed state of AudienceProtocolMapper
	// +optional
	Status AudienceProtocolMapperStatus `json:"status,omitempty,omitzero"`
}
