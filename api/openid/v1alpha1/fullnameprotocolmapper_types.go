...
type FullNameProtocolMapper struct {
	...
	// spec defines the desired state of FullNameProtocolMapper
	// +required
	Spec FullNameProtocolMapperSpec `json:"spec"`

	// status defines the observed state of FullNameProtocolMapper
	// +optional
	Status FullNameProtocolMapperStatus `json:"status,omitempty,omitzero"`
}
