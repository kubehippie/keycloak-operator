...
type GroupMembershipProtocolMapper struct {
	...
	// spec defines the desired state of GroupMembershipProtocolMapper
	// +required
	Spec GroupMembershipProtocolMapperSpec `json:"spec"`

	// status defines the observed state of GroupMembershipProtocolMapper
	// +optional
	Status GroupMembershipProtocolMapperStatus `json:"status,omitempty,omitzero"`
}
