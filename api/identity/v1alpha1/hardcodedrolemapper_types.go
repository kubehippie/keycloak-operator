...
type HardcodedRoleMapper struct {
	...
	// spec defines the desired state of HardcodedRoleMapper
	// +required
	Spec HardcodedRoleMapperSpec `json:"spec"`

	// status defines the observed state of HardcodedRoleMapper
	// +optional
	Status HardcodedRoleMapperStatus `json:"status,omitempty,omitzero"`
}
